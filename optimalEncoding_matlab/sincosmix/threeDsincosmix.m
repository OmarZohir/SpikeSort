...
saveas(gcf, 'SinCos_TotalSpikes.png');
...
title(lgd,'# of Neurons','FontSize',12);
xlabel("Time(s)");
title("RMSE decoder vs Size of Network (Reconstructed signal is NOT smoothened)")
ylabel("RMSE between Input and Reconstructed signal during optimal decoder training");
saveas(gcf, 'SinCos_RMSE_Decoder.png');
...
title("RMSE Test input vs Size of Network (Reconstructed signal is NOT smoothened)");
saveas(gcf, 'SinCos_RMSE_Testing.png');